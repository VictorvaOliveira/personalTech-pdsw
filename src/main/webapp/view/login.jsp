            ...
            <form action="LoginController" method="post">
                <div class="form-group">
                    ...
                    <select class="form-control" id="tipoUsuarioLogin" name="tipoUsuarioLogin">
                        <option>-- Escolha o tipo de usuário--</option>
                        <option selected value="P">Personal Trainer</option>
                        <option value="A">Aluno</option>
                    </select>
                </div>
                <div class="form-group">
                    <label for="Login">Login:</label>
                    <input type="text" class="form-control" id="email" placeholder="Enter login" name="login" required value="CB"/>
                </div>
                <div class="form-group">
                    <label for="pwd">Senha:</label>
                    <input type="password" class="form-control" id="pwd" placeholder="Enter password" name="senha" required value="CB123"/>
                </div>
